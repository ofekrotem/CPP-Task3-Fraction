...
namespace ariel {
    ...
    void Fraction::checkAddOverflow(Fraction frac) const {
        if ((this->numerator == MAX ^ this->denominator == MAX) || (this->numerator <= MIN + 100 && frac.getNumerator() <= MIN + 100)){
            throw overflow_error("overflow");
        }
    }

    void Fraction::checkSubOverflow(Fraction frac) const {
        if ((this->numerator <= MIN + 100 && frac.getNumerator() <= MIN + 100) || (this->numerator >= MAX - 100 && frac.getNumerator() <= MIN + 100)){
            throw overflow_error("overflow");
        }
    }
    ...
    void Fraction::checkMulOverflow(Fraction frac) const {
        if ((this->numerator == MAX ^ this->denominator == MAX) || (frac.getNumerator() == MAX && frac.getDenominator() != MAX)){
            throw overflow_error("overflow");
        }
    }
